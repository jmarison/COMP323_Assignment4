...
A pixel art platformer game with multiple levels, enemies, bonus items, and a scoring system.
Built with Pygame to demonstrate core game development concepts.
## Features
- Multiple levels with increasing difficulty
- Player character with animations for different states (idle, run, jump, etc.)
- Enemies with basic AI and animations
- Collectible bonus items (coins, gems, hearts)
- Parallax scrolling background
- Score tracking and leaderboard system
- Death animation and level transition screens
- Sprite-based graphics with fallback to simple shapes
## Controls
...
1. Player class - Handles player movement, animations, and state
2. Enemy class - Manages enemy behavior and animations
3. Platform class - Creates platforms for the player to stand on
4. BonusItem class - Collectible items that increase score
5. Level classes - Define the layout of platforms, enemies, and items
6. Background class - Handles parallax scrolling backgrounds
7. Various screen handlers for menu, leaderboard, etc.
## File Structure Requirements
- /tilesets/ folder for game graphics (platforms, enemies, bonus items)
- /sprites/ folder for player character animations
- leaderboard.json is created to store player scores
## Dependencies
- Pygame
- Python standard libraries (os, json, time, random, math, datetime)
"""
import pygame
import random
import time
